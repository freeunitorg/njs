...
$t->try_run('no readRequestForm')->plan(62);
...
like(http_post_form('/content_form',
    urlencoded_form('a=x%'),
    qr/500/s,
    'urlencoded trailing bare percent is a parse error');

like(http_post_form('/content_form',
    urlencoded_form('a=x%2'),
    qr/500/s,
    'urlencoded single-digit percent escape is a parse error');
